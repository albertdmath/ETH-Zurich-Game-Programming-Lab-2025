...
namespace src.GameObjects{
    public class Menu{
        ...
        public void LoadContent() {
            this.testTexture = game.Content.Load<Texture2D>("Font");
            ...
            var style = new UntexturedStyle(this.SpriteBatch) {
                ...
                Font = new GenericSpriteFont(
                    game.Content.Load<SpriteFont>("Fonts/TestFont"),
                    game.Content.Load<SpriteFont>("Fonts/TestFontBold"),
                    game.Content.Load<SpriteFont>("Fonts/TestFontItalic")),
                TextScale = 0.1F,
                ...
                AdditionalFonts = {{"Monospaced", new GenericSpriteFont(game.Content.Load<SpriteFont>("Fonts/MonospacedFont"))}},
            };
